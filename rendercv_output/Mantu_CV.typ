...
== Open Source
  ...
  main-column-second-row: [
    #summary[Expo config plugin to detect installed apps on Android and iOS (236.4K+ downloads)]
  ...
  main-column-second-row: [
    #summary[Real-time pose detection for React Native using MediaPipe BlazePose with GPU acceleration (7.4K+ downloads)]
