...
#show: rendercv.with(
  ...
  top-note: [ #emph[Last updated on Aug 23, 2026] ],
...
== Open Source
  ...
  main-column-second-row: [
    #summary[Expo config plugin to detect installed apps on Android and iOS (298.4K+ downloads)]
  ...
  main-column-second-row: [
    #summary[Real-time pose detection for React Native using MediaPipe BlazePose with GPU acceleration (15.9K+ downloads)]
