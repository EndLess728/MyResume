...
#show: rendercv.with(
  ...
  top-note: [ #emph[Last updated on Aug 16, 2026] ],
...
== Open Source
  ...
  main-column-second-row: [
    #summary[Expo config plugin to detect installed apps on Android and iOS (287.3K+ downloads)]
  ...
  main-column-second-row: [
    #summary[Real-time pose detection for React Native using MediaPipe BlazePose with GPU acceleration (14.0K+ downloads)]
